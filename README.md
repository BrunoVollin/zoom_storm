...
Online store built as a TypeScript microservices monorepo, following
**Clean Architecture** per service and a **CQRS + Event-Driven** pattern
with asynchronous projections via Kafka.
