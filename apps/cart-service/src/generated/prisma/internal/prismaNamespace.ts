...
> = {
  ...
  meta: {
    modelProps: 'coupon' | 'cart' | 'cartItem' | 'cartCoupon' | 'outboxEvent';
    ...
    CartCoupon: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.CartCouponCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type CartCouponScalarFieldEnum =
  (typeof CartCouponScalarFieldEnum)[keyof typeof CartCouponScalarFieldEnum];
