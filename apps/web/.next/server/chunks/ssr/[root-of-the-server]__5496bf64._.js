...
const authService = {
    ...
    async getCurrentUser () {
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$http$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["http"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$routes$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["BFF_ROUTES"].me);
            return data;
        } catch  {
            return null;
        }
    ...
    async logout (global = false) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$http$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["http"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$routes$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["BFF_ROUTES"].logout}${global ? "?global=true" : ""}`);
    }
};
}),
