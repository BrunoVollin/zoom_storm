module.exports = [
  "[project]/apps/web/.next-internal/server/app/api/auth/[...path]/route/actions.js [app-rsc] (server actions loader, ecmascript)",
  ...
  "[project]/apps/web/src/lib/bff-proxy.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";

    __turbopack_context__.s(["proxyToBff", () => proxyToBff]);
    var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/apps/web/node_modules/next/server.js [app-route] (ecmascript)",
      );
    ...
    async function proxyToBff(request, segments, prefix) {
      ...
      return new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
        "NextResponse"
  ...
  "[project]/apps/web/src/lib/create-proxy-route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";

    __turbopack_context__.s(["createProxyRoute", () => createProxyRoute]);
    var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$bff$2d$proxy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i("[project]/apps/web/src/lib/bff-proxy.ts [app-route] (ecmascript)");
    function createProxyRoute(prefix) {
      const handle = async (request, { params }) => {
        const { path } = await params;
        return (0,
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$bff$2d$proxy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
          "proxyToBff"
        ])(request, path, prefix);
      };
      return {
  ...
  "[project]/apps/web/src/app/api/auth/[...path]/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$create$2d$proxy$2d$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/apps/web/src/lib/create-proxy-route.ts [app-route] (ecmascript)",
      );
    const { GET, POST, PATCH, DELETE, PUT } = (0,
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$create$2d$proxy$2d$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
      "createProxyRoute"
    ])("/auth");
  },
];

//# sourceMappingURL=%5Broot-of-the-server%5D__b472fc07._.js.map
