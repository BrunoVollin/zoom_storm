module.exports = [
  "[project]/.next-internal/server/app/api/products/[...path]/route/actions.js [app-rsc] (server actions loader, ecmascript)",
  ...
  "[project]/src/lib/bff-proxy.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
  ...
  "[project]/src/lib/create-proxy-route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";

    __turbopack_context__.s(["createProxyRoute", () => createProxyRoute]);
    var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bff$2d$proxy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i("[project]/src/lib/bff-proxy.ts [app-route] (ecmascript)");
    function createProxyRoute(prefix) {
      const handle = async (request, { params }) => {
        const { path } = await params;
        return (0,
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bff$2d$proxy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
          "proxyToBff"
        ])(request, path, prefix);
      };
      return {
  ...
  "[project]/src/app/api/products/[...path]/route.ts [app-route] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$create$2d$proxy$2d$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i("[project]/src/lib/create-proxy-route.ts [app-route] (ecmascript)");
    const { GET, POST, PATCH, DELETE, PUT } = (0,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$create$2d$proxy$2d$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__[
      "createProxyRoute"
    ])("/products");
  },
];

//# sourceMappingURL=%5Broot-of-the-server%5D__e9c394ad._.js.map
