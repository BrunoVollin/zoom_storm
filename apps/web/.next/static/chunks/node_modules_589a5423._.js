...
var isWatched = (name, _names, isBlurEvent)=>!isBlurEvent && (_names.watchAll || _names.watch.has(name) || [
        ..._names.watch
    ].some((watchName)=>name.startsWith("".concat(watchName, "."))));
...
function createFormControl() {
    ...
    const setFieldValue = function(name, value1) {
        let options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, skipClone = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false;
        const field = get(_fields, name);
