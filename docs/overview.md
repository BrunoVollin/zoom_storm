...
|---|------|------|-------------|
| 1 | Authentication (login/callback/session/proxy) | [auth-flow.md](./auth-flow.md) | High |
| 2 | Product registration/edit/removal (write + projections) | [product-registration-flow.md](./product-registration-flow.md) | High |
| 3 | Product listing and lookup (read model) | [product-listing-flow.md](./product-listing-flow.md) | High |
| 4 | Cart creation | [create-cart-flow.md](./create-cart-flow.md) | High |
| 5 | Managing cart items (add/update/remove) | [manage-cart-items-flow.md](./manage-cart-items-flow.md) | High |
| 6 | Discount coupon (apply/remove) | [coupon-flow.md](./coupon-flow.md) | Medium |
| 7 | Shipping calculation | [shipping-flow.md](./shipping-flow.md) | Medium |
| 8 | Checkout | [checkout-flow.md](./checkout-flow.md) | High |
